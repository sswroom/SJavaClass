...
public class StringNotInCondition extends FieldCondition
{
	private Iterable<String> vals;

	public StringNotInCondition(@Nonnull String fieldName, @Nonnull Iterable<String> vals)
	{
		super(fieldName);
		this.vals = vals;
	}
	...
	{
		return new StringNotInCondition(this.fieldName, this.vals);
	}
