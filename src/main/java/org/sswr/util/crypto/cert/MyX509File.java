...
public abstract class MyX509File extends ASN1Data
{
	...
	public static boolean isSigned(@Nonnull byte[] pdu, int beginOfst, int endOfst, @Nonnull String path)
	{
	...
	public static boolean isTBSCertificate(@Nonnull byte[] pdu, int beginOfst, int endOfst, @Nonnull String path)
	{
		int cnt = ASN1Util.pduCountItem(pdu, beginOfst, endOfst, path);
		if (cnt < 6)
		{
	...
	public static boolean isCertificate(@Nonnull byte[] pdu, int beginOfst, int endOfst, @Nonnull String path)
	{
	...
	public static boolean isTBSCertList(@Nonnull byte[] pdu, int beginOfst, int endOfst, @Nonnull String path)
	{
		int cnt = ASN1Util.pduCountItem(pdu, beginOfst, endOfst, path);
		if (cnt < 4)
		{
	...
	public static boolean isCertificateList(@Nonnull byte[] pdu, int beginOfst, int endOfst, @Nonnull String path)
	{
	...
	public static boolean isPrivateKeyInfo(@Nonnull byte[] pdu, int beginOfst, int endOfst, @Nonnull String path)
	{
		int cnt = ASN1Util.pduCountItem(pdu, beginOfst, endOfst, path);
		if (cnt != 3 && cnt != 4)
		{
	...
	public static boolean isCertificateRequestInfo(@Nonnull byte[] pdu, int beginOfst, int endOfst, @Nonnull String path)
	{
		int cnt = ASN1Util.pduCountItem(pdu, beginOfst, endOfst, path);
		if (cnt < 4)
		{
	...
	public static boolean isCertificateRequest(@Nonnull byte[] pdu, int beginOfst, int endOfst, @Nonnull String path)
	{
	...
	public static boolean isContentInfo(@Nonnull byte[] pdu, int beginOfst, int endOfst, @Nonnull String path)
	{
	...
	public static boolean isPFX(@Nonnull byte[] pdu, int beginOfst, int endOfst, @Nonnull String path)
	{
		if (ASN1Util.pduGetItemType(pdu, beginOfst, endOfst, path) != ASN1Util.IT_SEQUENCE)
			return false;
		int cnt = ASN1Util.pduCountItem(pdu, beginOfst, endOfst, path);
