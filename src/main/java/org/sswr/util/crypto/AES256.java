...
public class AES256 extends BlockCipher implements Encryption
{
	private int encRK[];
	private int decRK[];
	...
	{
		super(16);
		this.encRK = new int[60];
		this.decRK = new int[60];
		this.setKey(key);
	}
	...
	public int encryptBlock(byte []inBlock, int inOfst, byte []outBlock, int outOfst, Object encParam)
	{
		...
		/* round 12: */
		s0 = AESBase.te0[(t0 >> 24) & 0xff] ^ AESBase.te1[(t1 >> 16) & 0xff] ^ AESBase.te2[(t2 >>  8) & 0xff] ^ AESBase.te3[t3 & 0xff] ^ this.encRK[48];
		s1 = AESBase.te0[(t1 >> 24) & 0xff] ^ AESBase.te1[(t2 >> 16) & 0xff] ^ AESBase.te2[(t3 >>  8) & 0xff] ^ AESBase.te3[t0 & 0xff] ^ this.encRK[49];
		s2 = AESBase.te0[(t2 >> 24) & 0xff] ^ AESBase.te1[(t3 >> 16) & 0xff] ^ AESBase.te2[(t0 >>  8) & 0xff] ^ AESBase.te3[t1 & 0xff] ^ this.encRK[50];
		s3 = AESBase.te0[(t3 >> 24) & 0xff] ^ AESBase.te1[(t0 >> 16) & 0xff] ^ AESBase.te2[(t1 >>  8) & 0xff] ^ AESBase.te3[t2 & 0xff] ^ this.encRK[51];
		/* round 13: */
		t0 = AESBase.te0[(s0 >> 24) & 0xff] ^ AESBase.te1[(s1 >> 16) & 0xff] ^ AESBase.te2[(s2 >>  8) & 0xff] ^ AESBase.te3[s3 & 0xff] ^ this.encRK[52];
		t1 = AESBase.te0[(s1 >> 24) & 0xff] ^ AESBase.te1[(s2 >> 16) & 0xff] ^ AESBase.te2[(s3 >>  8) & 0xff] ^ AESBase.te3[s0 & 0xff] ^ this.encRK[53];
		t2 = AESBase.te0[(s2 >> 24) & 0xff] ^ AESBase.te1[(s3 >> 16) & 0xff] ^ AESBase.te2[(s0 >>  8) & 0xff] ^ AESBase.te3[s1 & 0xff] ^ this.encRK[54];
		t3 = AESBase.te0[(s3 >> 24) & 0xff] ^ AESBase.te1[(s0 >> 16) & 0xff] ^ AESBase.te2[(s1 >>  8) & 0xff] ^ AESBase.te3[s2 & 0xff] ^ this.encRK[55];
	...
	public int decryptBlock(byte []inBlock, int inOfst, byte []outBlock, int outOfst, Object decParam)
	{
		...
		/* round 12: */
		s0 = AESBase.td0[(t0 >> 24) & 0xff] ^ AESBase.td1[(t3 >> 16) & 0xff] ^ AESBase.td2[(t2 >>  8) & 0xff] ^ AESBase.td3[t1 & 0xff] ^ this.decRK[48];
		s1 = AESBase.td0[(t1 >> 24) & 0xff] ^ AESBase.td1[(t0 >> 16) & 0xff] ^ AESBase.td2[(t3 >>  8) & 0xff] ^ AESBase.td3[t2 & 0xff] ^ this.decRK[49];
		s2 = AESBase.td0[(t2 >> 24) & 0xff] ^ AESBase.td1[(t1 >> 16) & 0xff] ^ AESBase.td2[(t0 >>  8) & 0xff] ^ AESBase.td3[t3 & 0xff] ^ this.decRK[50];
		s3 = AESBase.td0[(t3 >> 24) & 0xff] ^ AESBase.td1[(t2 >> 16) & 0xff] ^ AESBase.td2[(t1 >>  8) & 0xff] ^ AESBase.td3[t0 & 0xff] ^ this.decRK[51];
		/* round 13: */
		t0 = AESBase.td0[(s0 >> 24) & 0xff] ^ AESBase.td1[(s3 >> 16) & 0xff] ^ AESBase.td2[(s2 >>  8) & 0xff] ^ AESBase.td3[s1 & 0xff] ^ this.decRK[52];
		t1 = AESBase.td0[(s1 >> 24) & 0xff] ^ AESBase.td1[(s0 >> 16) & 0xff] ^ AESBase.td2[(s3 >>  8) & 0xff] ^ AESBase.td3[s2 & 0xff] ^ this.decRK[53];
		t2 = AESBase.td0[(s2 >> 24) & 0xff] ^ AESBase.td1[(s1 >> 16) & 0xff] ^ AESBase.td2[(s0 >>  8) & 0xff] ^ AESBase.td3[s3 & 0xff] ^ this.decRK[54];
		t3 = AESBase.td0[(s3 >> 24) & 0xff] ^ AESBase.td1[(s2 >> 16) & 0xff] ^ AESBase.td2[(s1 >>  8) & 0xff] ^ AESBase.td3[s0 & 0xff] ^ this.decRK[55];
	...
	public void setKey(byte []key)
	{
		...
		this.encRK[6] = ByteTool.readMInt32(key, 24);
		this.encRK[7] = ByteTool.readMInt32(key, 28);
		i = 0;
		while (true)
		{
			...
			this.encRK[i * 8 + 12] = this.encRK[i * 8 + 4] ^
				(AESBase.te4[(temp >> 24) & 0xff] & 0xff000000) ^
				(AESBase.te4[(temp >> 16) & 0xff] & 0x00ff0000) ^
				(AESBase.te4[(temp >>  8) & 0xff] & 0x0000ff00) ^
				(AESBase.te4[(temp      ) & 0xff] & 0x000000ff);
